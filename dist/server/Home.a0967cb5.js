...
function ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[--><section class="${renderer.ssrRenderClass($data.isMounted ? "banner banner__action" : "banner")}"><h1 class="${renderer.ssrRenderClass($data.isMounted ? "page-title page-title__action" : "page-title")}">Burton Hou</h1><img${renderer.ssrRenderAttr("src", $data.gh_black)} alt="gh_black" class="gh gh_black"><img${renderer.ssrRenderAttr("src", $data.gh_main)} alt="gh_main" class="gh gh_main"><img${renderer.ssrRenderAttr("src", $data.gh_left)} alt="gh_left" class="gh gh_left"><img${renderer.ssrRenderAttr("src", $data.gh_right)} alt="gh_right" class="gh gh_right"></section><div class="${renderer.ssrRenderClass($data.isMounted ? "hr hr__action" : "hr")}"></div><!--]-->`);
}
